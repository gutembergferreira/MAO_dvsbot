document.addEventListener('DOMContentLoaded', function() {
    const checkboxes = document.querySelectorAll('.select__flag');
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', togglePlaceholder);
    });

    // Inicializa o estado do placeholder ao carregar a página
    togglePlaceholder();
});
